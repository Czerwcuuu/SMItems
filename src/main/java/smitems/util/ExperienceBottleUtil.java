...
public class ExperienceBottleUtil {
    ...
    public static boolean registerEbRecipe(){
        ...
        if(success) SMItems.getInstance().getLogger().fine("Dodany przepis na "+ EB_KEY.getNamespace()+":"+EB_KEY.getKey());
        else SMItems.getInstance().getLogger().fine("NIEPOMYSLNE dodanie przepisu na: "+ EB_KEY.getNamespace()+":"+EB_KEY.getKey());
    ...
    public static boolean unregisterEbRecipe(){
        ...
        if(success) SMItems.getInstance().getLogger().fine("Usunieto przepis na:"+ EB_KEY.getNamespace()+":"+EB_KEY.getKey());

        else SMItems.getInstance().getLogger().fine("Nie udalo sie usunac przepisu na: "+ EB_KEY.getNamespace()+":"+EB_KEY.getKey());
